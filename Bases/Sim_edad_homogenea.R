...
sol  <- as.matrix(read.csv("Mat_PX.csv")[,2:14])
sol2 <- (abs(sol))
...
write.csv(prop.embarazos.edad[2:m],"Prop_Embarazos_edad_PX_homogeneo.csv")
write.csv(prop.embarazos[2:m],"Prop_Embarazos_PX_homogeneo.csv")
