...
sol  <- as.matrix(read.csv("Mat_X3.csv")[,2:14])
sol2 <- (abs(sol))
...
write.csv(prop.embarazos.edad[2:m],"Prop_Embarazos_edad_X3_homogeneo.csv")
write.csv(prop.embarazos[2:m],"Prop_Embarazos_X3_homogeneo.csv")
